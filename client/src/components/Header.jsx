...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.button onClick={onclickHandler} className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 cursor-pointer rounded-full'
      ...
      <motion.p className='mt-3 text-gray-500'
      initial={{opacity:0}}
      animate={{opacity:1}}
      transition={{delay:1.2,duration:0.8}}
      
      >Generated Images from Figurify</motion.p>
    </motion.div>
  )
}
