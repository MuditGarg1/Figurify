  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            {state === 'Login' ? <p onClick={()=> setState('SignUp')} className='mt-5 text-center'>Don't Have an account ? <span className='text-blue-600 cursor-pointer'>Sign Up</span></p>
            :
            ...
            <img onClick={() => setShowLogin(false)} src={assets.cross_icon} alt="" className='absolute top-5 right-5 cursor-pointer hover:bg-gray-300 rounded-full p-1 ' />
        </motion.form>
